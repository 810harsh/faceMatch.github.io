...
export const drawMesh = (predictions, ctx,) => {
    ...
    // ctx.stroke(circle);
    // ctx.beginPath();
    // ctx.arc(350, 200, 160, 0, 2 * Math.PI, true);
    ...
    ctx.beginPath();
    ctx.arc(350, 200, 160, 0, 2 * Math.PI, true);
    ctx.arc(350, 200, 154, 0, 2 * Math.PI, true);
    ctx.fillStyle = "red";
    ...
    // ((box.xMax <= 510 && box.xMin >= 190) && (box.yMax <= 360 && box.yMin >= 40))
    ...
    if (predictions.length > 0) {
        ...
        if (((box.xMax <= 510 && box.xMin >= 190) && (box.yMax <= 360 && box.yMin >= 40))) {

            // const circle1 = new Path2D();
            // circle1.arc(350, 200, 160, 0, 2 * Math.PI, true);
            // ctx.strokeStyle = "green";
            // ctx.font = "50px serif";
            // ctx.strokeText("You are detected", 100, 35);
            // ctx.stroke(circle1);
            ctx.beginPath();
            ctx.arc(350, 200, 160, 0, 2 * Math.PI, true);
            ctx.arc(350, 200, 154, 0, 2 * Math.PI, true);
            ...
            // ctx.fillStyle = "Black";
            ctx.fillText("You are detected", 150, 30);
            ctx.fill("evenodd");
            ...
            // use the callback function to take the screenshot
            //  set some interval after that take the screenshot 
